...
def main():
    ...
    if 'differences_json' not in st.session_state:
        ...
        st.write(visual_edit, unsafe_allow_html=True)
        st.markdown("""
                    <hr>
                    <br>
                    <p> If you do not see your revision, then please go back to Revision page on the left side bar, and click 'Finish Revision' button at the bottom. </p>
                    <br><br>
                    """, unsafe_allow_html=True)
